# 
# Project automation script for xilinx_ise_14.7 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source xilinx_ise_14.7.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "../bmp_pkg.vhd"
   xfile add "../calculate_alpha_compensated.vhd"
   xfile add "../calculate_alpha_cp.vhd"
   xfile add "../calculate_kgain.vhd"
   xfile add "../calculate_pix_gain.vhd"
   xfile add "../calculate_pixos.vhd"
   xfile add "../calculate_pixos_cp_sp.vhd"
   xfile add "../calculate_raw_image.vhd"
   xfile add "../calculate_ta.vhd"
   xfile add "../calculate_to.vhd"
   xfile add "../calculate_vdd.vhd"
   xfile add "../calculate_vir_compensated.vhd"
   xfile add "../cd.vhd"
   xfile add "../colormap_brewer_ygb.vhd"
   xfile add "../colormap_heat.vhd"
   xfile add "../colormap_magma.vhd"
   xfile add "../colormap_pkg.vhd"
   xfile add "../colormap_rainbow.vhd"
   xfile add "../colormap_viridis.vhd"
   xfile add "../documentation/header_denotes.vhd"
   xfile add "../documentation/header_practices.vhd"
   xfile add "../documentation/header_tb.vhd"
   xfile add "../documentation/header_template.vhd"
   xfile add "../extract_alpha_correction_range_1234.vhd"
   xfile add "../extract_alpha_parameters.vhd"
   xfile add "../extract_ct_34_parameters.vhd"
   xfile add "../extract_ksto_1234_parameters.vhd"
   xfile add "../extract_kta_parameters.vhd"
   xfile add "../extract_kv_parameters.vhd"
   xfile add "../extract_offset_parameters.vhd"
   xfile add "../extract_tgc_parameters.vhd"
   xfile add "../fast_inverse_sqrt.vhd"
   xfile add "../fphdl/env_c.vhdl"
   xfile add "../fphdl/fixed_float_types_c.vhdl"
   xfile add "../fphdl/fixed_noresize.vhdl"
   xfile add "../fphdl/fixed_pkg_c.vhdl"
   xfile add "../fphdl/fixed_synth.vhdl"
   xfile add "../fphdl/float_noround_pkg.vhdl"
   xfile add "../fphdl/float_pkg_c.vhdl"
   xfile add "../fphdl/float_synth.vhdl"
   xfile add "../fphdl/numeric_std_additions.vhdl"
   xfile add "../fphdl/numeric_std_unsigned_c.vhdl"
   xfile add "../fphdl/standard_additions_c.vhdl"
   xfile add "../fphdl/standard_textio_additions_c.vhdl"
   xfile add "../fphdl/std_logic_1164_additions.vhdl"
   xfile add "../fphdl/test_fixed_synth.vhdl"
   xfile add "../fphdl/test_float_synth.vhdl"
   xfile add "../global_package.vhd"
   xfile add "../i2c_stream.vhd"
   xfile add "../ipcore_dir/addfp.xco"
   xfile add "../ipcore_dir/divfp.xco"
   xfile add "../ipcore_dir/dualmem.xco"
   xfile add "../ipcore_dir/dualmem_rawimg.xco"
   xfile add "../ipcore_dir/dualmem_temperature.xco"
   xfile add "../ipcore_dir/fixed2float.xco"
   xfile add "../ipcore_dir/float2fixed.xco"
   xfile add "../ipcore_dir/float2fixed_rawimg.xco"
   xfile add "../ipcore_dir/float2fixed_temperature.xco"
   xfile add "../ipcore_dir/i2c_mem.xco"
   xfile add "../ipcore_dir/i2c_mlx.xco"
   xfile add "../ipcore_dir/inst_mem_kvdd_vdd25.xco"
   xfile add "../ipcore_dir/mem_i2c_stream.xco"
   xfile add "../ipcore_dir/mulfp.xco"
   xfile add "../ipcore_dir/sqrtfp2.xco"
   xfile add "../ipcore_dir/subfp.xco"
   xfile add "../ipcore_dir/tb_data_calculateTo.xco"
   xfile add "../ipcore_dir/tb_i2c_mem.xco"
   xfile add "../lcd_display.vhd"
   xfile add "../melexis_mlx90640_i2c.vhd"
   xfile add "../melexis_mlx9064x.vhd"
   xfile add "../mem_minus256.vhd"
   xfile add "../mem_ramb16_s36_x2.vhd"
   xfile add "../mem_signed256.vhd"
   xfile add "../mem_switchpattern.vhd"
   xfile add "../p_package1.vhd"
   xfile add "../pack.vhd"
   xfile add "../rom_constants.vhd"
   xfile add "../tb/tb_ExtractKsTaParameters.vhd"
   xfile add "../tb/tb_ExtractKtPTATParameter.vhd"
   xfile add "../tb/tb_ExtractKtaParameters_schematic.vhd"
   xfile add "../tb/tb_ExtractKvPTATParameter.vhd"
   xfile add "../tb/tb_ExtractVDDParameters.vhd"
   xfile add "../tb/tb_calculate_alpha_compensated.vhd"
   xfile add "../tb/tb_calculate_alpha_cp.vhd"
   xfile add "../tb/tb_calculate_kgain.vhd"
   xfile add "../tb/tb_calculate_pix_gain.vhd"
   xfile add "../tb/tb_calculate_pixos.vhd"
   xfile add "../tb/tb_calculate_pixos_cp_sp.vhd"
   xfile add "../tb/tb_calculate_raw_image.vhd"
   xfile add "../tb/tb_calculate_ta.vhd"
   xfile add "../tb/tb_calculate_to.vhd"
   xfile add "../tb/tb_calculate_vdd.vhd"
   xfile add "../tb/tb_calculate_vir_compensated.vhd"
   xfile add "../tb/tb_data_calculatedTo.vhd"
   xfile add "../tb/tb_extract_alpha_correction_range_1234.vhd"
   xfile add "../tb/tb_extract_alpha_parameters.vhd"
   xfile add "../tb/tb_extract_ksto_scale_parameter.vhd"
   xfile add "../tb/tb_extract_kta_parameters.vhd"
   xfile add "../tb/tb_extract_kv_parameters.vhd"
   xfile add "../tb/tb_extract_offset_parameters.vhd"
   xfile add "../tb/tb_extract_tgc_parameters.vhd"
   xfile add "../tb/tb_fast_inverse_sqrt.vhd"
   xfile add "../tb/tb_i2c_r.vhd"
   xfile add "../tb/tb_i2c_stream.vhd"
   xfile add "../tb/tb_melexis_mlx90640_i2c.vhd"
   xfile add "../tb/tb_melexis_mlx9064x.vhd"
   xfile add "../tb/tb_mem_float2powerN.vhd"
   xfile add "../tb/tb_mem_kvdd_vdd25.vhd"
   xfile add "../tb/tb_mem_kvptat_ktptat.vhd"
   xfile add "../tb/tb_mem_ramb16_16bit_address_dual.vhd"
   xfile add "../tb/tb_mem_ramb16_16bit_address_single.vhd"
   xfile add "../tb/tb_mem_ramb16_s36_x2.vhd"
   xfile add "../tb/tb_mem_switchpattern.vhd"
   xfile add "../tb/tb_rom_constants.vhd"
   xfile add "../tb/tb_signed1024.vhd"
   xfile add "../tb/tb_sqrt2.vhd"
   xfile add "../tb/tb_test1.vhd"
   xfile add "../tb/tb_test2.vhd"
   xfile add "../tb/tb_top.vhd"
   xfile add "../tb/tb_top_copy.vhd"
   xfile add "../tb/tb_vts.vhd"
   xfile add "../test1.ucf"
   xfile add "../test1.vhd"
   xfile add "../test2.ucf"
   xfile add "../test2.vhd"
   xfile add "../vga_address_generator.vhd"
   xfile add "../vga_bmp_sink.vhd"
   xfile add "../vga_timing.vhd"
   puts ""
   puts "WARNING: project contains IP cores, synthesis will fail if any of the cores require regenerating."
   puts ""

   # Set the Top Module as well...
   project set top "Behavioral" "test1"
...
proc create_libraries {} {
   ...
   lib_vhdl new "ieee_proposed"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/fixed_float_types_c.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/fixed_synth.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/numeric_std_additions.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/fixed_noresize.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/float_pkg_c.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/standard_additions_c.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/std_logic_1164_additions.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/float_synth.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/fixed_pkg_c.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/test_fixed_synth.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/numeric_std_unsigned_c.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/env_c.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/float_noround_pkg.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/standard_textio_additions_c.vhdl"
      lib_vhdl add_file "ieee_proposed" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/fphdl/test_float_synth.vhdl"
...
proc set_process_props {} {
   ...
   project set "Last Applied Strategy" "Runtime Strategy 1;/home/user/.local/Xilinx/14.7/ISE_DS/ISE/spartan3e/data/spartan3e_runtime.xds"
   ...
   project set "Case Implementation Style" "Full-Parallel" -process "Synthesize - XST"
   ...
   project set "User Browsed Strategy Files" "/home/user/.local/Xilinx/14.7/ISE_DS/ISE/data/default.xds"
   ...
   project set "Target UCF File Name" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/xilinx_ise_14.7/melexis_mlx90640_i2c.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Work Directory" "/home/user/_WORKSPACE_/kedziorno/mlx90640_fpga/xilinx_ise_14.7/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "test1" -process "Generate IBIS Model"
