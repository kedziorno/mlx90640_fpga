...
proc add_source_files {} {
   ...
   xfile add "../tb/tb_CalculateAlphaCP.vhd"
   xfile add "../tb/tb_CalculateAlphaComp.vhd"
   xfile add "../tb/tb_CalculateGetImage.vhd"
   xfile add "../tb/tb_CalculateKGain.vhd"
   xfile add "../tb/tb_CalculateOffsetCP.vhd"
   xfile add "../tb/tb_CalculatePixGain.vhd"
   xfile add "../tb/tb_CalculatePixOS.vhd"
   xfile add "../tb/tb_CalculatePixOsCPSP.vhd"
   xfile add "../tb/tb_CalculateTa.vhd"
   xfile add "../tb/tb_CalculateTo.vhd"
   xfile add "../tb/tb_CalculateVirCompensated.vhd"
   xfile add "../tb/tb_ExtractAlphaCorrRange1234.vhd"
   xfile add "../tb/tb_ExtractAlphaParameters.vhd"
   xfile add "../tb/tb_ExtractAlphaPtatParameter.vhd"
   xfile add "../tb/tb_ExtractCPParameters.vhd"
   xfile add "../tb/tb_ExtractCT34Parameter.vhd"
   xfile add "../tb/tb_ExtractKsTaParameters.vhd"
   xfile add "../tb/tb_ExtractKsTo1234Parameters.vhd"
   xfile add "../tb/tb_ExtractKsToScaleParameter.vhd"
   xfile add "../tb/tb_ExtractKtPTATParameter.vhd"
   xfile add "../tb/tb_ExtractKtaParameters.vhd"
   xfile add "../tb/tb_ExtractKtaParameters_schematic.vhd"
   xfile add "../tb/tb_ExtractKvPTATParameter.vhd"
   xfile add "../tb/tb_ExtractKvParameters.vhd"
   xfile add "../tb/tb_ExtractOffsetParameters.vhd"
   xfile add "../tb/tb_ExtractTGCParameters.vhd"
   ...
   xfile add "../tb/tb_mem_ramb16_s36_s36_x2.vhd"
   ...
   xfile add "../tb/tb_test_fixed_melexis.vhd"
   ...
   project set top "rtl" "${module_name}"
...
proc set_process_props {} {
   ...
   project set "Output File Name" "$module_name" -process "Generate IBIS Model"
