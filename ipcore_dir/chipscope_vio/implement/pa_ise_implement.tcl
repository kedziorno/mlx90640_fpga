...
#-----------------------------------------------------------------------------
add_files -norecurse {../example_design/example_chipscope_vio.vhd}
#add_files -norecurse {../example_design/example_chipscope_vio.ucf}
set_property target_constrs_file {../example_design/example_chipscope_vio.ucf} [current_fileset -constrset]
import_ip -file {chipscope_icon.xco} -name chipscope_icon
generate_target { all } [get_ips chipscope_icon]
set_property top example_chipscope_vio [get_filesets sources_1]
