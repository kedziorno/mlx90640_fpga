# 
# Project automation script for melexis_mlx90641 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source melexis_mlx90641.tcl), then you can
...
set myProject "melexis_mlx90641"
set myScript "melexis_mlx90641.tcl"
...
proc add_source_files {} {
   ...
   xfile add "CalculateAlphaCP.sch"
   xfile add "CalculateAlphaCP_process_p0.vhd"
   xfile add "CalculateAlphaComp.sch"
   xfile add "CalculateAlphaComp_process_p0.vhd"
   xfile add "CalculateGetImage.vhd"
   xfile add "CalculateKGain_process_p0.vhd"
   xfile add "CalculateOffsetCP.vhd"
   xfile add "CalculatePixGain.sch"
   xfile add "CalculatePixGain_process_p0.vhd"
   xfile add "CalculatePixOS.sch"
   xfile add "CalculatePixOSCpSp.sch"
   xfile add "CalculatePixOSCpSp_process_p0.vhd"
   xfile add "CalculatePixOS_process_p0.vhd"
   xfile add "CalculatePixOsCPSP.vhd"
   xfile add "CalculateTa.sch"
   xfile add "CalculateTo.sch"
   xfile add "CalculateTo_process_p0.vhd"
   xfile add "CalculateVDD.sch"
   xfile add "CalculateVDD_pow2_2bit.vhd"
   xfile add "CalculateVDD_process_p0.vhd"
   xfile add "CalculateVirCompensated.sch"
   xfile add "CalculateVirCompensated_process_p0.vhd"
   xfile add "ExtractAlphaCorrRange1234.vhd"
   xfile add "ExtractAlphaPTATParameter.sch"
   xfile add "ExtractAlphaParameters.sch"
   xfile add "ExtractAlphaParameters_process_p0.vhd"
   xfile add "ExtractAlphaPtatParameter.vhd"
   xfile add "ExtractCPParameters.vhd"
   xfile add "ExtractCT34Parameter.vhd"
   xfile add "ExtractKsTaParameter_process_p0.vhd"
   xfile add "ExtractKsTaParameters.sch"
   xfile add "ExtractKsTo1234Parameters.vhd"
   xfile add "ExtractKsToScaleParameter.sch"
   xfile add "ExtractKsToScaleParameter_process_p0.vhd"
   xfile add "ExtractKtPTATParameter.sch"
   xfile add "ExtractKtaParameters.sch"
   xfile add "ExtractKtaParameters_process_p0.vhd"
   xfile add "ExtractKtaParameters_process_p1.vhd"
   xfile add "ExtractKvPTATParameter.sch"
   xfile add "ExtractKvParameters.sch"
   xfile add "ExtractKvParameters_process_p0.vhd"
   xfile add "ExtractKvParameters_process_p1.vhd"
   xfile add "ExtractOffsetParameters.sch"
   xfile add "ExtractOffsetParameters_process_p0.vhd"
   xfile add "ExtractTGCParameter.sch"
   xfile add "ExtractTGCParameter_process_p0.vhd"
   xfile add "ExtractTGCParameters.vhd"
   xfile add "ExtractVDDParameters.sch"
   xfile add "ExtractVDDParameters_process_p0.vhd"
   xfile add "address_generator.vhd"
   xfile add "calculateKGain.vhd"
   xfile add "calculateTa_process_p0.vhd"
   xfile add "calculateVdd.vhd"
   xfile add "colrow_even.vhd"
   xfile add "i2c_r.vhd"
   ...
   xfile add "mem_float2powerN.vhd"
   xfile add "mem_ramb16_s36_x2.vhd"
   xfile add "mem_signed1024.vhd"
   xfile add "mem_signedFF.vhd"
   xfile add "mem_switchpattern.sch"
   xfile add "mem_unsigned1024.vhd"
   xfile add "mux2x1.vhd"
   xfile add "mux3x1.vhd"
   xfile add "mux3x1a.vhd"
   xfile add "mux4x1.vhd"
   xfile add "mux_addr.vhd"
   xfile add "p_fphdl_package1.vhd"
   xfile add "p_fphdl_package2.vhd"
   xfile add "p_fphdl_package3.vhd"
   xfile add "p_package1.vhd"
   xfile add "p_package1_constants.vhd"
   xfile add "rom_alphascale.vhd"
   xfile add "rom_alphascalepow27.vhd"
   xfile add "rom_cpp12p0_ratio.vhd"
   xfile add "rom_signed10bit.sch"
   xfile add "rom_signed3bit.vhd"
   xfile add "rom_signed4bit.vhd"
   xfile add "rom_signed6bit.vhd"
   xfile add "rom_signed8bit.sch"
   xfile add "rom_switchpattern_neg.vhd"
   xfile add "rom_switchpattern_pos.vhd"
   xfile add "rom_unsigned4bit.vhd"
   xfile add "rom_unsigned4bit_2powx.vhd"
   xfile add "rom_unsigned4bit_2powx8.vhd"
   xfile add "tb_CalculateAlphaCP.vhd"
   xfile add "tb_CalculateAlphaComp.vhd"
   xfile add "tb_CalculateGetImage.vhd"
   xfile add "tb_CalculateOffsetCP.vhd"
   xfile add "tb_CalculatePixGain.vhd"
   xfile add "tb_CalculatePixOS.vhd"
   xfile add "tb_CalculatePixOsCPSP.vhd"
   xfile add "tb_CalculateTo.vhd"
   xfile add "tb_CalculateVirCompensated.vhd"
   xfile add "tb_ExtractAlphaCorrRange1234.vhd"
   xfile add "tb_ExtractAlphaParameters.vhd"
   xfile add "tb_ExtractAlphaPtatParameter.vhd"
   xfile add "tb_ExtractCPParameters.vhd"
   xfile add "tb_ExtractCT34Parameter.vhd"
   xfile add "tb_ExtractKsTaParameters.vhd"
   xfile add "tb_ExtractKsTo1234Parameters.vhd"
   xfile add "tb_ExtractKsToScaleParameter.vhd"
   xfile add "tb_ExtractKtPTATParameter.vhd"
   xfile add "tb_ExtractKtaParameters.vhd"
   xfile add "tb_ExtractKtaParameters_schematic.vhd"
   xfile add "tb_ExtractKvPTATParameter.vhd"
   xfile add "tb_ExtractKvParameters.vhd"
   xfile add "tb_ExtractOffsetParameters.vhd"
   xfile add "tb_ExtractTGCParameters.vhd"
   xfile add "tb_ExtractVDDParameters.vhd"
   xfile add "tb_calculateKGain.vhd"
   xfile add "tb_calculateTa.vhd"
   xfile add "tb_calculateVdd.vhd"
   xfile add "tb_mem_ramb16_s36_s36_x2.vhd"
   xfile add "tb_mem_switchpattern.vhd"
   xfile add "tb_test1.vhd"
   xfile add "tb_test_fixed_melexis.vhd"
   xfile add "tb_test_speed_addfp.vhd"
   xfile add "tb_test_speed_divfp.vhd"
   xfile add "tb_test_speed_fixed2float.vhd"
   xfile add "tb_test_speed_float2fixed.vhd"
   xfile add "tb_test_speed_mulfp.vhd"
   xfile add "tb_test_speed_sqrtfp2.vhd"
   xfile add "tb_test_speed_subfp.vhd"
   xfile add "tb_top.vhd"
   xfile add "tb_vts.vhd"
   xfile add "test1.ucf"
   xfile add "test1.vhd"
   xfile add "test_fixed_melexis.sch"
   xfile add "test_fixed_melexis.ucf"
   xfile add "test_fixed_melexis.vhd"
   xfile add "test_speed_addfp.vhd"
   xfile add "test_speed_divfp.vhd"
   xfile add "test_speed_fixed2float.vhd"
   xfile add "test_speed_float2fixed.vhd"
   xfile add "test_speed_mulfp.vhd"
   xfile add "test_speed_sqrtfp2.vhd"
   xfile add "test_speed_subfp.vhd"
   xfile add "top.ucf"
   xfile add "top.vhd"
   xfile add "vga_imagegenerator.vhd"
...
proc set_process_props {} {
   ...
   project set "Number of Global Clock Buffers" "32" -process "Synthesize - XST"
   ...
   project set "User Browsed Strategy Files" "/home/user/.local/Xilinx/14.7/ISE_DS/ISE/virtex4/data/virtex4_performance_with_iobpacking.xds"
   ...
   project set "Target UCF File Name" "/home/user/workspace/mlx90640_fpga/top.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Use DSP48" "Auto" -process "Synthesize - XST"
   ...
   project set "Configuration Pin Powerdown" "Pull Up" -process "Generate Programming File"
   ...
   project set "Work Directory" "/home/user/workspace/mlx90640_fpga/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "test_fixed_melexis" -process "Generate IBIS Model"
   ...
   project set "Number of Regional Clock Buffers" "24" -process "Synthesize - XST"
   project set "Functional Model Target Language" "VHDL" -process "View HDL Source"
   project set "Change Device Speed To" "-10" -process "Generate Post-Place & Route Static Timing"
   project set "Change Device Speed To" "-10" -process "Generate Post-Map Static Timing"
