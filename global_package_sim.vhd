...
-- Module Name:   global_package_sim
...
--    - Files: -
--    - Modules: -
--  - Revision 0.02 - i2c constants for VHDL module in simulation
--    - Files: -
--    - Modules: -
--
-- Important objects:
...
--  constant c_clock_i2c_frequency : natural := 1_000_000; -- XXX mlx90640 have default 1us clock period
  constant c_clock_i2c_frequency : natural := 2;
...
end package global_package_sim;

package body global_package_sim is
...
end package body global_package_sim;
